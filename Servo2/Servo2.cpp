...
uint8_t Servo2::attachedA = 0;
uint8_t Servo2::attachedB = 0;

void Servo2::seizeTimer1()
{
...
void Servo2::releaseTimer1() {}

#define NO_ANGLE (0xff)

Servo2::Servo2() : pin(0), angle(NO_ANGLE) {}

uint8_t Servo2::attach2(int pinArg)
{
  return attach2(pinArg, 544, 2400);
}

uint8_t Servo2::attach2(int pinArg, int min, int max)
{
...
void Servo2::write2(int angleArg)
{
  uint16_t p;
...
uint8_t Servo2::read2()
{
  return angle;
}

uint8_t Servo2::attached2()
{
